...
class Restaurant(Base):
    ...
    slug = Column(String, unique=True, index=True, nullable=False)  # QR URL
    ...
    google_review_url = Column(String, nullable=True)  # write-a-review link
    manager_contacts_json = Column(Text, nullable=True)  # JSON list of contact options
    ...
    contact_requests = relationship(
        "ContactRequest", back_populates="restaurant", cascade="all, delete-orphan"
    )
